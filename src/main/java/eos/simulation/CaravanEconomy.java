 ...
 * The three colonies share the session's {@link eos.name.NameRegistry} and {@link
 * eos.mortality.Demography} (so dynasty surnames are unique across all of them) but
