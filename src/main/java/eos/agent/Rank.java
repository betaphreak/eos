 ...
 * {@link #HOLDING} the firms/banks a {@link eos.agent.noble.Noble noble} owns,
 * {@link #VILLAGE} a settlement a {@link eos.agent.ruler.Ruler ruler} leads); the
...
public enum Rank {
	...
	/** A centralized physical asset — what a {@link eos.agent.noble.Noble noble} owns. */
	...
	/** An interconnected network of holdings — what a {@link eos.agent.ruler.Ruler ruler} leads. */
