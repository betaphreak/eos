...
import com.civstudio.io.printer.WeddingPrinter;
 ...
 * AbstractHousehold#seekSpouseIfSingle()}). On a weekend the market
...
public class WeddingMarket extends Market {
	 ...
	 * WeddingPrinter}. {@code cost} is the bride-price actually
