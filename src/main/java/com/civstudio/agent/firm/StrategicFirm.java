...
import com.civstudio.good.Strategic;
 ...
 * Noble}s, who supply skill-scaled labor exactly as laborers do
...
public class StrategicFirm extends Firm {
	...
	/** The export firm produces in the {@link Sector#EXPORT} sector. */
	@Override
	public Sector sector() {
		return Sector.EXPORT;
	}
