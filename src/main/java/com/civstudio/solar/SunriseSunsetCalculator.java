...
public class SunriseSunsetCalculator {
     ...
     */
    public  AbstractMap.SimpleImmutableEntry<Integer, Integer>  getAstronomicalSunriseForDate(Calendar date) {
     ...
     */
    public  AbstractMap.SimpleImmutableEntry<Integer, Integer>  getAstronomicalSunsetForDate(Calendar date) {
     ...
     */
    public AbstractMap.SimpleImmutableEntry<Integer, Integer> getNauticalSunriseForDate(Calendar date) {
     ...
     */
    public AbstractMap.SimpleImmutableEntry<Integer, Integer> getNauticalSunsetForDate(Calendar date) {
     ...
     */
    public AbstractMap.SimpleImmutableEntry<Integer, Integer> getCivilSunriseForDate(Calendar date) {
     ...
     */
    public AbstractMap.SimpleImmutableEntry<Integer, Integer> getCivilSunsetForDate(Calendar date) {
     ...
     */
    public AbstractMap.SimpleImmutableEntry<Integer, Integer> getOfficialSunriseForDate(Calendar date) {
     ...
     */
    public AbstractMap.SimpleImmutableEntry<Integer, Integer> getOfficialSunsetForDate(Calendar date) {
    ...
    public static Calendar getSunrise(double latitude, double longitude, TimeZone timeZone, Calendar date, double degrees) {
        SolarEventCalculator solarEventCalculator = new SolarEventCalculator(new GeoLocation(latitude, longitude), timeZone);
